...
\begin{cventries}
    ...
    {High Throughput Bulk Ordering System \href{https://visionvid.vercel.app/}{\faGithubSquare}} % Project Name
    {Sysco LABS} % Location
    {2024} % Date(s)
    {
    ...
    {WiseBaseAI - GenAI Knowledge Management System \href{https://visionvid.vercel.app/}{\faGithubSquare}} % Project Name
